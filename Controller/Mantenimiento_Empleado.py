...
class ArregloEmpleados:
    ...
    def cargar(self):
        archivo = open("Model/Empleados.txt", "r", encoding = "utf-8")
    ...
    def grabar(self):
        archivo = open("Model/Empleados.txt", "w+", encoding= "utf-8")
        for i in range(self.tamañoArregloEmpleado()):
            archivo.write(str(self.devolverEmpleado(i).getDniEmpleado()) + "," + str(self.devolverEmpleado(i).getNombresEmpleado()) + "," + str(self.devolverEmpleado(i).getApellidoPaternoEmpleado()) + "," + str(self.devolverEmpleado(i).getApellidoMaternoEmpleado()) + "," + str(self.devolverEmpleado(i).getDireccionEmpleado()) + "," + str(self.devolverEmpleado(i).getTelefonoEmpleado()) + "\n")
        archivo.close()
